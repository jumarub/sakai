...
public class GlobalController {
	...
	public String handleAdminError(HttpServletRequest req, Exception ex, RedirectAttributes redirectAttributes) {
	...
	@ResponseBody
	public AjaxResponse handleCredentialsError(HttpServletRequest req, Exception ex, RedirectAttributes redirectAttributes) {
		AjaxResponse ret = new AjaxResponse();
		ret.setStatus(false);
		ret.setError(rb.containsKey(ex.getMessage()) ? rb.getString(ex.getMessage()) : ex.getMessage());
		return ret;
	}
}
